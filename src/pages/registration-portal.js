...
import RegistrationPortal from '@uz/unitz-pages-advisor/RegistrationPortal';

const RegistrationPortalIndex = withPageContext((props) => {
  return (
    <App>
...
export default RegistrationPortalIndex;
