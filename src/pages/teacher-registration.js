...
import RegistrationProcess from '@uz/unitz-pages-advisor/RegistrationProcess';

const TeacherRegistrationIndex = withPageContext((props) => {
  return (
    <App>
...
export default TeacherRegistrationIndex;
